...
function open_tickets() {
    ...
    add.innerHTML = '<center><button class="back-button" onclick="back_home()">Back</button><h1 id="logo"><a href="./index.html">Golden coins</a></h1><div id="earn_balance">' + balance + '</div><br><br>' + ad1 + '<br><br><br><button class="extract-button" onclick="extract_ticket()"></button><br><br><div><h2 id="result"></h2></div><div><b id="win-or-lose"></b></div><br><br><br><h1>TEAMLEADER SUBSCRIPTION PLAN</h1><br>  <div class="columns"><ul class="price"><li class="header">💵TL SUBSCRIPTION</li><li class="black">₱8000,00</li><li class="grey"><button class="button" onclick="purchase_tickets13()" style="cursor: pointer">PAYPAL Purchase</button></li></ul></div><div class="columns"><ul class="price"><li class="header">💵🔥TL SUBSCRIPTION</li><li class="black">₱8000,00</li><li class="grey"><button class="button" onclick="purchase_ticketsD()" style="cursor: pointer">PAYNAMICS PURCHASE</button></li></ul></div><br>' + ad2 + '<br><br></center>';
}
...
function open_chatbox2() {
  ...
  random_num = Math.floor((Math.random() * 128) + 0);
    link = links[random_num];
    ad1 = ads1[random_num];
    add.innerHTML = '<center><button class="back-button" onclick="back_home()">Back</button><h1 id="logo"><a href="./index.html">kindly post your message, create topics and monitor your golden coins in progress</a></h1><div id="earn_balance">' + balance + '</div><iframe width="560" height="685" style="background-color: white;" src="https://timeclack-ph.netlify.app/home&index=' + random_num +
'&autoplay=1&mute=1&loop=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br></br><iframe src="https://my.cbox.ws/HIGHLIGHTSRADIO" allow="microphone; camera; fullscreen; autoplay; display-capture" style="width: 560; height: 600; overflow: hidden; border: 0px none; background-color: transparent;"></iframe><br><br>' + ad1 + '<button class="home-button" style="top: 1% ;" onclick="back_home()">Stop Earning</button></center>';
  if (balance == 0) {
add.innerHTML = 'You have no tickets, purchase or refill atleast 200 goldencoins to access this feature.'
  }
  window.open(link);
