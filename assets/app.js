...
function extract_ticket() { //extract 1 ticket
  var add = document.getElementById("add-section");
    add.innerHTML = '<center><button class="back-button" onclick="back_home()">Back</button><h1 id="logo"><a href=". /index.html">GOLDEN COINS </a></h1><br><br><iframe src="./withdrawal.html" width="100%" height="70%" style="background-color: #b46b59;"></iframe></center>';
    var tickets = document.getElementById("earn_balance");
    if (balance == 0) {
        result.innerHTML = 'You have no tickets.'
    }
...
function open_chatbox() {
    ...
    add.innerHTML = '<center><button class="back-button" onclick="back_home()">Back</button><h1 id="logo"><a href="./index.html">kindly post your, create topics and monitor your golden coins in progress</a></h1><div id="earn_balance">' + balance + '</div><iframe width="560" height="100%" style="background-color: white;" src="https://timeclack-ph.netlify.app"&index=' + random_num + '&autoplay=1&mute=1&loop=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br><br>' + ad1 + '<button class="home-button" style="top: 85% ;" onclick="back_home()">Stop Earning</button></center>';
